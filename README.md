...
services:
    ...
    adminer:
        ...
        labels:
            ...
            - "traefik.http.routers.adminer.rule=Host(`adminer.1596561508.localhost`)"  
    ...
    php:
        ...
        labels:
            ...
            - "traefik.http.routers.php.rule=Host(`php.1596561508.localhost`)"
